...
ancho_ventana = root.winfo_screenwidth()-100
alto_ventana = 650
posicion_x = int(root.winfo_screenwidth() / 2 - ancho_ventana / 2)
posicion_y = int(root.winfo_screenheight() / 2 - alto_ventana / 2)
...
label = tk.Label(root, image=photo)
label.grid(row=1, column=5, padx=10, pady=5,columnspan=3)  
...
# Crear un widget Label para mostrar la imagen
label2 = tk.Label(root, image=photo2)
label2.grid(row=1, column=0, padx=10, pady=5,columnspan=4)  

 # Etiquetas y campos de entrada para el cálculo de k
 #Titulo para la primera parte
tk.Label(root, text="Determinación del equivalente en agua del calorímetro",font=("Arial",18),background='white').grid(row=0, column=0, padx=10, pady=5, sticky=tk.E,columnspan=3)

tk.Label(root, text="m (gramos de agua a  temperatura T):",font=("Arial",10),background='white').grid(row=2, column=0, padx=10, pady=5, sticky=tk.E)
...
entry_mh20k.grid(row=2, column=2, padx=20, pady=5)
...
tk.Label(root, text="M (gramos de agua en el calorimetro \n a  temperatura T0):",font=("Arial",10),background='white').grid(row=3, column=0, padx=10, pady=5, sticky=tk.E)
entry_MT0k = tk.Scale(root, from_=50, to=125, orient=tk.HORIZONTAL, length=300,sliderlength=20, tickinterval=10, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_MT0k.grid(row=3, column=2, padx=20, pady=5)
btn_agregar_MT0k= tk.Button (root, text="Agregar", command=lambda c=2: agregar(c))
btn_agregar_MT0k.grid(row=3, column=3, columnspan=1, padx=10, pady=5)


tk.Label(root, text="T (Temperatura del agua hirviendo):",font=("Arial",10),background='white').grid(row=4, column=0, padx=10, pady=5, sticky=tk.E)
entry_mTh20k = tk.Scale(root, from_=80, to=100, orient=tk.HORIZONTAL, length=300,sliderlength=20,  tickinterval=2, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_mTh20k.grid(row=4, column=2, padx=10, pady=5)
btn_agregar_mTh20k= tk.Button(root, text="Agregar", command=lambda c=3: agregar(c))
btn_agregar_mTh20k.grid(row=4, column=3, columnspan=1, padx=10, pady=5)

tk.Label(root, text="T0 ( T0 del agua en el calorimetro):",font=("Arial",10),background='white').grid(row=5, column=0, padx=10, pady=5, sticky=tk.E)
entry_MT0h20k = tk.Scale(root, from_=10, to=23, orient=tk.HORIZONTAL, length=300,sliderlength=20,  tickinterval=1, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_MT0h20k.grid(row=5, column=2, padx=10, pady=5)
btn_agregar_MT0h20k= tk.Button(root, text="Agregar", command=lambda c=4: agregar(c))
btn_agregar_MT0h20k.grid(row=5, column=3, columnspan=1, padx=10, pady=5)

tk.Label(root, text="Te (temperatura de equilibrio \n del agua en el calorimetro):",font=("Arial",10),background='white').grid(row=6, column=0, padx=10, pady=5, sticky=tk.E)
entry_Teh20K = tk.Scale(root, from_=20, to=30, orient=tk.HORIZONTAL, length=300,sliderlength=20, tickinterval=1, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_Teh20K.grid(row=6, column=2, padx=10, pady=5)
btn_agregar_Teh20K= tk.Button(root, text="Agregar", command=lambda c=5: agregar(c))
btn_agregar_Teh20K.grid(row=6, column=3, columnspan=1, padx=10, pady=5)

# Botón para calcular k

btn_calcular_k = tk.Button(root, text="Calcular k", command=calcular_k,font=("Arial",10),background='white')
btn_calcular_k.grid(row=7, column=1, columnspan=2, padx=10, pady=5)
...
#SEGUNDA PARTE
#Titulos
tk.Label(root, text="Determinación del calor específico del sólido",font=("Arial",18),background='white').grid(row=0, column=5, padx=10, pady=5, sticky=tk.E,columnspan=2)

# Etiquetas y campos de entrada para el cálculo de c
tk.Label(root, text="m (masa del sólido en gramos):",font=("Arial",10),background='white').grid(row=2, column=5, padx=10, pady=5, sticky=tk.E)
entry_msc = tk.Scale(root, from_=50, to=100, orient=tk.HORIZONTAL, length=300,sliderlength=20,  tickinterval=10, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_msc.grid(row=2, column=6, padx=10, pady=5)
entry_msc.configure(state='disabled')
btn_agregar_msc= tk.Button(root, text="Agregar",  command=lambda c=6: agregar(c))
btn_agregar_msc.configure(state='disabled')
btn_agregar_msc.grid(row=2, column=7, columnspan=1, padx=10, pady=5)


tk.Label(root, text="M (masa del fluido - agua en gramos):",font=("Arial",10),background='white').grid(row=3, column=5, padx=10, pady=5, sticky=tk.E)
entry_Mc = tk.Scale(root, from_=50, to=125, orient=tk.HORIZONTAL, length=300,sliderlength=20, tickinterval=10, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_Mc.grid(row=3, column=6, padx=10, pady=5)
entry_Mc.configure(state='disabled')
btn_agregar_Mc= tk.Button(root, text="Agregar", command=lambda c=7: agregar(c))
btn_agregar_Mc.grid(row=3, column=7, columnspan=1, padx=10, pady=5)
btn_agregar_Mc.configure(state='disabled')

tk.Label(root, text="T (temperatura del fluido hirviendo > 80°C):",font=("Arial",10),background='white').grid(row=4, column=5, padx=10, pady=5, sticky=tk.E)
entry_Tc = tk.Scale(root, from_=80, to=100, orient=tk.HORIZONTAL, length=300,sliderlength=20, tickinterval=2, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_Tc.grid(row=4, column=6, padx=10, pady=5)
entry_Tc.configure(state='disabled')
btn_agregar_Tc= tk.Button(root, text="Agregar", command=lambda c=8: agregar(c))
btn_agregar_Tc.grid(row=4, column=7, columnspan=1, padx=10, pady=5)
btn_agregar_Tc.configure(state='disabled')

tk.Label(root, text="T0 (temperatura inicial del fluido):",font=("Arial",10),background='white').grid(row=5, column=5, padx=10, pady=5, sticky=tk.E)
entry_T0c = tk.Scale(root, from_=10, to=23, orient=tk.HORIZONTAL, length=300,sliderlength=20, tickinterval=1, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_T0c.grid(row=5, column=6, padx=10, pady=5)
entry_T0c.configure(state='disabled')
btn_agregar_T0c= tk.Button(root, text="Agregar", command=lambda c=9: agregar(c))
btn_agregar_T0c.grid(row=5, column=7, columnspan=1, padx=10, pady=5)
btn_agregar_T0c.configure(state='disabled')

tk.Label(root, text="Te (temperatura de equilibrio del fluido):",font=("Arial",10),background='white').grid(row=6, column=5, padx=10, pady=5, sticky=tk.E)
entry_Teh20c = tk.Scale(root, from_=20, to=30, orient=tk.HORIZONTAL, length=300,sliderlength=20, tickinterval=1, 
                       bg="lightblue", highlightthickness=0,troughcolor="white")
entry_Teh20c.grid(row=6, column=6, padx=10, pady=5)
entry_Teh20c.configure(state='disabled')
btn_agregar_Teh20c= tk.Button(root, text="Agregar", command=lambda c=10: agregar(c))
btn_agregar_Teh20c.grid(row=6, column=7, columnspan=1, padx=10, pady=5)
btn_agregar_Teh20c.configure(state='disabled')
...
btn_calcular_c.grid(row=7, column=5, columnspan=2, padx=10, pady=5)
# Botón para reinicia app
btn_reset = tk.Button(root, text="REINICIAR", command=reiniciarApp,background='red')
btn_reset.grid(row=7, column=6, columnspan=2, padx=10, pady=5)
